/*************************************************************************************
*                                                                                    *
* HTran.cpp - HUC Packet Transmit Tool V1.1.1.                                       *
*                                                                                    *
...
void * _wfopen(const wchar_t * file, const wchar_t * arg);
#endif
...
void getctrlc(int j);
void closeallfd();
void makelog(char *buffer, unsigned int length);
